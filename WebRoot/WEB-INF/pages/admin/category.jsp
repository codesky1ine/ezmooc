...
<html>
	<head>
		...
		<script type="text/javascript" src="/ezmooc/js/admin/category.js"></script>
	</head>
					...
					<form class="form-horizontal" id="updateForm" >
						<div class="modal-body">
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" name="courseCatgName" id="update_ccname"
										placeholder="请输入课程类别" value="" required="">
								</div>
								<div style="height:43px;margin: 0px 0px 0px 21.5%;" id="update_ccname_validate">
								</div>
							</div>
							<input type="hidden" name="courseCatgId" id="update_ccuid" value="">
						</div>
					...
					<form class="form-horizontal" id="addForm" method="post" >
						<div class="modal-body">
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" name="courseCatgName" id="add_ccname"
										placeholder="请输入课程类别" value="" required="" >
								</div>
