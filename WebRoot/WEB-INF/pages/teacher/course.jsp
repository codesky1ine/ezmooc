...
<html>
	<head>
		...
		<script type="text/javascript" src="/ezmooc/js/teacher/course.js"></script>
	</head>
							...
							<form class="form-horizontal" id="addForm" enctype="multipart/form-data">
								<div class="modal-body">
									<div class="form-group">
										...
										<div class="col-xs-10" id="addCategorySelect"></div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label">
											课程名
										...
										<div class="col-xs-10">
											<input class="form-control" type="text" name="courseName" id="add_cname" required=""
												placeholder="请输入课程名" value="">
										</div>
										<div style="height:43px;margin: 0px 0px 0px 21.5%;" id="add_cname_validate">
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label">
										...
										<div class="col-xs-10">
											<textarea class="form-control" rows="3" name="courseInfo" id="add_cinfo"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form class="form-horizontal" id="editForm" enctype="multipart/form-data">
								<div class="modal-body">
									<input type="hidden" name="courseId" id="edit_cuid">
									<div class="form-group">
										<label class="col-xs-2 control-label">
											课程类别
										</label>
										<div class="col-xs-10" id="editCategorySelect"></div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label">
											课程名
										...
										<div class="col-xs-10">
											<input class="form-control" type="text" name="courseName" id="edit_cname" required=""
												placeholder="请输入课程名" value="">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-10">
											<textarea class="form-control" rows="3" name="courseInfo" id="edit_cinfo"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-2 control-label">
