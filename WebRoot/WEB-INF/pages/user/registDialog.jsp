					...
					<form class="form-horizontal" id="user_regist" 
						...
						<div class="modal-body">
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" name="uaccount"  id="_uaccount" style="width:90%"
							...
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input class="form-control" type="password" name="password" id="_upass" style="width:90%"
							...
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input class="form-control" type="password" id="_reupass" style="width:90%"
							...
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input class="form-control" type="text" name="userName" id="_unickName" style="width:90%"
